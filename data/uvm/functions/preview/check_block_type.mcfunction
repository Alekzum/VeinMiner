...
# execute if score @s uvm.debug matches 1 run tellraw @s ["\u00a76[UVM Debug][check_block_type]\u00a7r tools: ", {"storage":"uvm:data","nbt":"tools"}," | custom: ", {"storage":"uvm:data", "nbt":"custom_tools", "interpret": false}]
