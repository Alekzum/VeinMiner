execute if score @s uvm.notified matches 0 if score debug uvm.config matches 1 run tellraw @a [{"text":"[mine_tree] ", "color":"gray"}, "route mining to ", {"nbt": "temp1.mining_mode", "storage": "uvm:data"}]
