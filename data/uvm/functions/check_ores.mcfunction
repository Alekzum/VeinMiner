...
execute if score @s uvm.trigger_view matches 1 if score @s uvm.debug matches 1 run tellraw @s [{"text":"[uvm:", "color":"gray", "extra":[{"text":"check_ores", "color":"gold"}, "] "]}, "is mined ore? ", {"score": {"name": "@s", "objective": "uvm.is_mined_ore"}}]
