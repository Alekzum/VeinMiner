...
execute if items entity @s weapon.mainhand *[minecraft:enchantments~[{enchantment:"minecraft:silk_touch"}]] run scoreboard players set @s uvm.silk 10

execute if items entity @s weapon.mainhand *[minecraft:enchantments~[{enchantment:"minecraft:fortune",levels:1}]] run scoreboard players set @s uvm.silk 1
execute if items entity @s weapon.mainhand *[minecraft:enchantments~[{enchantment:"minecraft:fortune",levels:2}]] run scoreboard players set @s uvm.silk 2
execute if items entity @s weapon.mainhand *[minecraft:enchantments~[{enchantment:"minecraft:fortune",levels:3}]] run scoreboard players set @s uvm.silk 3
