...
tellraw @a ""
tellraw @a ["", {"text": "Quick Add Commands:", "color": "yellow"}]
tellraw @a ["", {"text": "  /function uvm:add_ore {b:\"stone\"}", "color": "aqua"}]
tellraw @a ["", {"text": "  /function uvm:add_ore {b:\"cobblestone\"}", "color": "aqua"}]
