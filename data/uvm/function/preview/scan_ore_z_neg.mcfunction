...
execute if block ~ ~-1 ~-1 air run function uvm:scan_ore_z_neg_y_neg
execute if block ~ ~1 ~-1 air run function uvm:scan_ore_z_neg_y_pos
execute if block ~-1 ~ ~-1 air run function uvm:scan_ore_z_neg_x_neg
execute if block ~1 ~ ~-1 air run function uvm:scan_ore_z_neg_x_pos
