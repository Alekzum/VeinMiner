...
execute if block ~ ~1 ~-1 air run function uvm:scan_ore_z_pos_y_neg
execute if block ~ ~1 ~1 air run function uvm:scan_ore_z_pos_y_pos
execute if block ~-1 ~1 ~ air run function uvm:scan_ore_y_pos_x_neg
execute if block ~1 ~1 ~ air run function uvm:scan_ore_y_pos_x_pos
