...
execute if data entity @s SelectedItem.components."minecraft:enchantments"."minecraft:silk_touch" run scoreboard players set @s uvm.silk 10

execute if data entity @s SelectedItem.components."minecraft:enchantments"{"minecraft:fortune":1} run scoreboard players set @s uvm.silk 1
execute if data entity @s SelectedItem.components."minecraft:enchantments"{"minecraft:fortune":2} run scoreboard players set @s uvm.silk 2
execute if data entity @s SelectedItem.components."minecraft:enchantments"{"minecraft:fortune":3} run scoreboard players set @s uvm.silk 3
