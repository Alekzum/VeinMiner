...
# if vein drop items
execute if entity @n[nbt={Age:0s},distance=..5.0, type=item] anchored eyes positioned ^ ^ ^1.5 at @n[nbt={Age:0s},distance=..5.0,type=item] run return run function uvm:route_mining
execute if entity @n[nbt={Age:0s},distance=..5.0, type=experience_orb] anchored eyes positioned ^ ^ ^1.5 at @n[nbt={Age:0s},distance=..5.0,type=experience_orb] run return run function uvm:route_mining
