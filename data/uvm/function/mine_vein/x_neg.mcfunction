...
execute if block ~-1 ~ ~1 air run function uvm:mine_vein/z_pos_x_neg
execute if block ~-1 ~-1 ~ air run function uvm:mine_vein/y_neg_x_neg
execute if block ~-1 ~1 ~ air run function uvm:mine_vein/y_pos_x_neg
